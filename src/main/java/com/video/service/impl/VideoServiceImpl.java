...
import com.video.mapper.CommentedStarMapper;
...
public class VideoServiceImpl implements IVideoService {
    ...
    public String addComment(int starNum, Long userId, Long videoId) {
        TVideo video = videoMapper.selectByPrimaryKey(videoId);
        TUser user = userMapper.selectById(video.getUser().getUserId());
